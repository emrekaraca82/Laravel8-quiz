...
class QuestionController extends Controller
{
    ...
    {
        $quiz = Quiz::whereId($id)->with('questions')->first() ?? abrot('404','Quiz bulunamadı');
    ...
    {
        $question = Quiz::find($quiz_id)->questions()->whereId($question_id)->first() ?? abort(404,'Quiz yada Question sayfa bulunamadı');
